...
@includes('backend.layout.header')
    ...
    <section id="content_wrapper">
           ...
           <form>
  <div class="form-group" action="{{action('CourseController@coursestore')}}" method="post">{{csrf_field()}}
    <label for="exampleInputEmail1"> Courses Code</label>
    <input type="text" name="course_code" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter course">
    
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Course Name</label>
    <input type="text" name="course_name" class="form-control" id="exampleInputPassword1" placeholder="Enter Your course">
  </div>
